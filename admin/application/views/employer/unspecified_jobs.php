...
<div class="panel panel-flat">
	<div class="panel-body">
		<legend class="text-semibold "><i class=" icon-users4 position-left"></i> آگهی های تایید نشده</legend>
		...
		<table class="table datatable-selection-single table-hover table-responsive-sm ">
			<thead>
				<tr>
					<th width="18%">ردیف</th>
					<th width="18%"> عنوان شغل</th>
					<th width="18%">مکان</th>
					<th width="18%">دسته بندی شغل</th>
					<th width="18%">وضعیت</th>
					<th width="18%" class="text-center">ابزارک</th>
				</tr>
			</thead>
			...
			<tbody>
				<tr class="base_cust">
					...
					<td>شیراز</td>
					<td>برنامه نویس</td>
					<td><a><span class="label label-info">تایید نشده</span></a>
					</td>
