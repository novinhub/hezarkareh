    ...
    function sent(){
        ...
        if(isset($job_id) and is_numeric($job_id)){
           ...
           if(empty($resume)){
               ...
               $check = $this->base_model->get_data('sent' , 'id' , 'row' , array('job_id'=>$id , 'applicant_id'=>$user_id));
               if(empty($check)){
                   $data['job_id'] = $job_id;
