            ...
            <div class="job-listing-container">
              <div class="filtered-job-listing-wrapper">
                  ...
                  <div class="job-view-controller">
                    ...
                    <div class="job-view-filter">
                      <select class="selectpicker">
                         <option  value="" selected>جدید ترین</option>
                        <option value="california">بیشترین بازدید</option>
                        <option value="las-vegas">محبوب ترین</option>
                ...
                <div class="job-filter-result">
                  <div class="job-list">
                    ...
                    <div class="body">
                      <div class="content">
                        <h4><a href="<?php echo base_url('jobs/details')?>">آشپز فست فود </a></h4>
                        <div class="info">
                          ...
                          <span class="job-type temporary"><a href="#"><i data-feather="clock"></i>موقت</a></span>
                        </div>
                      </div>
                      <div class="more">
                        <div class="buttons">
                          <a href="#" class="button">ارسال رزومه</a>
              ...
              <div class="job-filter-wrapper">
                ...
                <div data-id="job-type" class="job-filter job-type same-pad">
                  <h4 class="option-title">نوع کار</h4>
                  <ul>
                    <li class="full-time"><i data-feather="clock"></i><a href="#" data-attr="Full Time">تمام وقت</a></li>
                    <li class="part-time"><i data-feather="clock"></i><a href="#" data-attr="Part Time">نیمه وقت</a></li>
                    <li class="freelance"><i data-feather="clock"></i><a href="#" data-attr="Freelance">فریلنسر</a></li>
                    <li class="temporary"><i data-feather="clock"></i><a href="#" data-attr="Temporary">موقت</a></li>
                  </ul>
                </div>
                <div data-id="experience" class="job-filter experience same-pad">
                  <h4 class="option-title">سابقه کار</h4>
                  <ul>
                    <li><a href="#" data-attr="Fresh">کاراموز</a></li>
                    <li><a href="#" data-attr="Less than 1 year">کمتر از 1 سال</a></li>
                    <li><a href="#" data-attr="2 Year">2 سال </a></li>
                    <li><a href="#" data-attr="3 Year">3 سال</a></li>
                    <li><a href="#" data-attr="4 Year">4 سال و بیشتر</a></li>
                  </ul>
                </div>
                <div data-id="gender" class="job-filter same-pad gender">
                  <h4 class="option-title">جنسیت</h4>
                  <ul>
                    <li><a href="#" data-attr="Male">مرد</a></li>
                    <li><a href="#" data-attr="Female">زن</a></li>
                  </ul>
                </div>
