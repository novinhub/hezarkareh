...
<head>
  <meta charset="UTF-8">
  <title>404 Error | hezarkareh</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
  
  
      <link rel="stylesheet" href="<?php echo base_url('files/');?>assets/404/css/style.css">
...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
			...
			<p class="subheading">به نظر میرسد صفحه که به دنبال آن هستید وجود ندارد</p>
      <a href="<?php echo base_url('home');?>" class="back "><span class="bg-light">بازگشت به خانه</span></a>
		</div>
	</div>
