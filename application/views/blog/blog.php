              ...
              <div class="row">
                <div class="col-md-6 col-lg-4">
                  <article class="blog-grid">
                    <div class="body">
                      <h3><a href="blog-details.html">شروع کار 1000 کاره</a></h3>
                      <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از.</p>
                    </div>
                    <div class="info">
                      <span class="author"><a href="#"><i data-feather="user"></i>علی شیرازی</a></span>
                ...
                <div class="col-md-6 col-lg-4">
                  <article class="blog-grid">
                    <div class="thumb">
                      <img src="<?php echo base_url('files/')?>images/blog/thumb-1.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="body">
                      <h3><a href="blog-details.html">سخت کوشی ایرانیان</a></h3>
                      <p>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از.</p>
                    </div>
                    <div class="info">
                      <span class="author"><a href="#"><i data-feather="user"></i>علی شیرازی</a></span>
                ...
                <div class="col-md-6 col-lg-4">
                  <article class="blog-grid">
                    <div class="thumb">
                      <img src="<?php echo base_url('files/')?>images/blog/thumb-3.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="body">
                      <span class="date">22 <span>Dec</span></span>
                      <h3><a href="blog-details.html">Who chooses to enjoy a pleasure</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                  <article class="blog-grid">
                    <div class="thumb">
                      <img src="<?php echo base_url('files/')?>images/blog/thumb-2.jpg" class="img-fluid" alt="">
                    </div>
                    <div class="body">
                      <span class="date">22 <span>Dec</span></span>
                      <h3><a href="blog-details.html">Who chooses to enjoy a pleasure</a></h3>
